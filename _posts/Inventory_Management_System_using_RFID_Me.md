...
tags: [aws, website, development, lambda, api gateway, dynamodb, iot, rfid, raspberry pi]     # TAG names should always be lowercase
mermaid: true
---
...
![Alt text](analytics1.png) ![Alt text](analytics2.png)
